...
import { users, payments, mentoringSessions, profiles, mentors } from "~/shared/db/schema";
...
export async function loader({ params }: Route.LoaderArgs) {
    ...
    // Fetch Mentoring
    const sessionList = await db.select().from(mentoringSessions).where(eq(mentoringSessions.userId, userId)).orderBy(desc(mentoringSessions.createdAt));
