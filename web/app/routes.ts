...
export default [
	...
	route(
		...
		"features/notifications/apis/api.notifications.trigger.ts",
	),
	route(
		"api/notifications/process-queue",
		"features/notifications/apis/api.notifications.process-queue.ts",
	),
	...
	route("api/ads/serve", "features/ads/apis/ads.ts"),
