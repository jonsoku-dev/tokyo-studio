		...
		<Shell>
            <div className="py-10">
                <div className="text-center mb-10">
			        <h1 className="text-3xl font-bold text-gray-900 mb-2">Let's build your strategy</h1>
                    <p className="text-gray-600">Answer 3 simple questions to get a personalized roadmap.</p>
                </div>
