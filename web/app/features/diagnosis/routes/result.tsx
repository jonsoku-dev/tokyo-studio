...
export default function DiagnosisResult({ loaderData }: Route.ComponentProps) {
	...
	return (
		<Shell>
			<div className="max-w-4xl mx-auto stack-lg py-8">
				{/* Header */}
				<div className="text-center stack">
					<div className="inline-center w-16 h-16 rounded-full bg-accent-100 text-accent-600 mb-4">
				...
				<div className="grid md:grid-cols-2 gap-6">
					{items.map((item, _idx) => (
						<div
							key={item.title}
							className="card-sm border border-gray-200 p-6 hover:shadow-md transition-shadow"
						>
				...
				{/* Next Steps CTA */}
				<div className="bg-gradient-to-r from-primary-500 to-amber-500 rounded-2xl p-8 text-white relative overflow-hidden">
					<div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
						...
						<Link
							to="/"
							className="bg-white text-primary-600 px-6 py-3 rounded-lg font-bold hover:bg-gray-50 transition-colors inline-flex items-center gap-2"
						>
