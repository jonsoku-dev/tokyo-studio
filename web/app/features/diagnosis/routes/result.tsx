...
import { ArrowRight, CheckCircle, Globe, Briefcase, Award } from "lucide-react";
...
export async function loader({ request }: Route.LoaderArgs) {
    ...
    const { items, strategy } = diagnosisService.calculateRecommendations(profile);
        ...
        <Shell>
            <div className="max-w-4xl mx-auto space-y-8 py-8">
                ...
                <div className="text-center space-y-4">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">Your Personal Strategy: {strategy.replace("_", " ")}</h1>
                    <p className="text-xl text-gray-600">
                        Based on your profile as a <span className="font-semibold text-gray-900">{profile.level} {profile.jobFamily}</span> engineer.
                    </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl p-8 text-white relative overflow-hidden">
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div>
                            ...
                            <p className="text-orange-50">Your roadmap has been generated based on this strategy.</p>
                        </div>
                        <Link 
                            to="/" 
