...
export async function loader({ request }: Route.LoaderArgs) {
    ...
    try {
        ...
        const result = await paymentService.confirmPayment(paymentKey, orderId, Number(amount));
            ...
            <div className="max-w-md mx-auto py-20 text-center">
                {loaderData.success ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <Button variant="outline" onClick={() => navigate("/payment/checkout")}>Try Again</Button>
                    </div>
                )}
            </div>
        </Shell>
