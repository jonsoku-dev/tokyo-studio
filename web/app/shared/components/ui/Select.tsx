...
export function SelectValue({
	...
	return (
		<span className={cn("block flex-1 truncate text-left", className)}>
			{hasContent ? content : (placeholder || <span className="text-transparent">Select</span>)}
		</span>
	);
}
...
export function SelectItem({
	...
	return (
		...
		>
			...
			<span className="block truncate font-normal group-data-[selected]:font-medium" title={typeof children === 'string' ? children : undefined}>
				{children}
			</span>
		</ListboxOption>
	);
